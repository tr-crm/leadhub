            ...
            <div class="row justify-content-center">
                <div class="col-xxl-4 col-md-6 col-sm-8">
                    ...
                    <div class="card p-4 rounded-4">
                        <form method="POST" action="<?= base_url('loginCheck') ?>" class="text-start mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="email" class="form-control" name="email" id="userEmail" placeholder="you@example.com" value="user@demo.com">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control" name="password" id="userPassword" placeholder="••••••••" value="password">
                                </div>
                            </div>
