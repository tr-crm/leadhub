                                ...
                                <Col lg={6}>
                                    <div className="card-body">
                                        ...
                                        <p className="mt-4 text-muted text-center mb-4">
                                            Don’t have a code?{' '}
                                            <Link to="" className="text-decoration-underline link-offset-2 fw-semibold">Resend</Link> or{' '}
                                            <Link to="" className="text-decoration-underline link-offset-2 fw-semibold">Call Us</Link>
                                        </p>
