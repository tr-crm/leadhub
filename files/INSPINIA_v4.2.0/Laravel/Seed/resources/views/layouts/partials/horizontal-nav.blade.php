    ...
    <nav class="navbar navbar-expand-lg">
        <nav class="container-fluid">
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('second', ['layouts-eg', 'horizontal'])}}">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-auth-v1">
                            <a href="{{ route('second', ['auth1','login'])}}" class="dropdown-item">Menu Item Link</a>
                            <a href="{{ route('second', ['auth1','login'])}}" class="dropdown-item">Menu Item Link</a>
                        </div>
                    </li>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-layouts">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="topnav-layouts-one">
                                    <a href="{{ route('second', ['auth1','login'])}}" class="dropdown-item">Sub Item</a>
                                    <a href="{{ route('second', ['auth1','login'])}}" class="dropdown-item">Sub Item</a>
                                </div>
                            </div>
                        </div>
