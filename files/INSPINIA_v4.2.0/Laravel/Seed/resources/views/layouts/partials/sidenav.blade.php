        ...
        <ul class="side-nav">
                    ...
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarOneAuth">
                                <ul class="sub-menu">
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ route('second', ['auth1', 'sign-up'])}}" class="side-nav-link">
                                            <span class="menu-text">Sign Up</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ route('second', ['auth1', 'reset-pass'])}}" class="side-nav-link">
                                            <span class="menu-text">Reset Password</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ route('second', ['auth1', 'new-pass'])}}" class="side-nav-link">
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ route('second', ['auth1', 'lock-sreen'])}}" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarTwoAuth">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ route('second', ['auth2', 'sign-in'])}}" class="side-nav-link">
                                            <span class="menu-text">Sign In</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ route('second', ['auth2', 'sign-up'])}}" class="side-nav-link">
                                            <span class="menu-text">Sign Up</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ route('second', ['auth2', 'reset-pass'])}}" class="side-nav-link">
                                            <span class="menu-text">Reset Password</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ route('second', ['auth2', 'new-pass'])}}" class="side-nav-link">
                                            <span class="menu-text">New Password</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarThreeAuth">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ route('second', ['auth3', 'sign-in'])}}" class="side-nav-link">
                                            <span class="menu-text">Sign In</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ route('second', ['auth3', 'sign-up'])}}" class="side-nav-link">
                                            <span class="menu-text">Sign Up</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ route('second', ['auth3', 'reset-pass'])}}" class="side-nav-link">
                                            <span class="menu-text">Reset Password</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ route('second', ['auth3', 'new-pass'])}}" class="side-nav-link">
                                            <span class="menu-text">New Password</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarLayouts">
                    <ul class="sub-menu">
                        ...
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['layouts-eg', 'outlook'])}}" target="_blank" class="side-nav-link">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="themeSkin">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['skin', 'classic'])}}" target="_blank" class="side-nav-link">
                                <span class="menu-text">Classic (Default)</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['skin', 'saas'])}}" target="_blank" class="side-nav-link">
                                <span class="menu-text">SaaS</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['skin', 'material'])}}" target="_blank" class="side-nav-link">
                                <span class="menu-text">Material</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['skin', 'modern'])}}" target="_blank" class="side-nav-link">
                                <span class="menu-text">Modern</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['skin', 'minimal'])}}" target="_blank" class="side-nav-link">
                                <span class="menu-text">Minimal</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['skin', 'flat'])}}" target="_blank" class="side-nav-link">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarSidebars">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['sidebar','light'])}}" target="_blank" class="side-nav-link">
                                <span class="menu-text">Light Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['sidebar','gradient'])}}" target="_blank" class="side-nav-link">
                                <span class="menu-text">Gradient Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['sidebar','gray'])}}" target="_blank" class="side-nav-link">
                                <span class="menu-text">Gray Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['sidebar','image'])}}" target="_blank" class="side-nav-link">
                                <span class="menu-text">Image Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['sidebar','compact'])}}" target="_blank" class="side-nav-link">
                                <span class="menu-text">Compact Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['sidebar','icon-view'])}}" target="_blank" class="side-nav-link">
                                <span class="menu-text">Icon View Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['sidebar','on-hover'])}}" target="_blank" class="side-nav-link">
                                <span class="menu-text">On Hover Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['sidebar','on-hover-active'])}}" target="_blank" class="side-nav-link">
                                <span class="menu-text">On Hover Active</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['sidebar','offcanvas'])}}" target="_blank" class="side-nav-link">
                                <span class="menu-text">Offcanvas Menu</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['sidebar','no-icons'])}}" target="_blank" class="side-nav-link">
                                <span class="menu-text">No Icons with Lines</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('second', ['sidebar','with-lines'])}}" target="_blank" class="side-nav-link">
