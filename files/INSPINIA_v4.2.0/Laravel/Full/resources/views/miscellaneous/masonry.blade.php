@extends('layouts.vertical', ['title' => 'Masonry'])
...
@include('layouts.partials/page-title', ['subtitle' => 'Miscellaneous', 'title' => 'Masonry'])
        ...
        <article class="card">
            ...
            <div class="card-body">
                ...
                <h6 class="card-title fs-lg lh-base mb-2">
                    <a href="{{ route('third', ['apps', 'others', 'article'])}}" class="link-reset">Mastering Figma: 7 Pro Tips for Better UI Design</a>
                </h6>
            ...
            <div class="card-footer bg-transparent d-flex justify-content-between">
                ...
                <a class="link-primary fw-semibold" href="{{ route('third', ['apps', 'others', 'article'])}}">Read more <i class="ti ti-arrow-right"></i></a>
            </div>
        </article>
    </div>
    <div class="col-xl-3 col-md-6">
    ...
    <div class="col-xl-3 col-md-6">
        <article class="card bg-danger bg-gradient">
            ...
            <div class="card-body">
                ...
                <!-- Title -->
                <h6 class="card-title fs-lg lh-base mb-2">
                    <a href="{{ route('third', ['apps', 'others', 'article'])}}" class="text-white">AI Breakthroughs to Watch in 2025</a>
                </h6>
            ...
            <div class="card-footer bg-transparent d-flex justify-content-between border-light border-opacity-25">
                ...
                <a class="text-white fw-semibold" href="{{ route('third', ['apps', 'others', 'article'])}}">Read more <i class="ti ti-arrow-right"></i></a>
            </div>
        </article>
    ...
    <div class="col-xl-3 col-md-6">
        <article class="card">
            ...
            <div class="card-body">
                <!-- Title -->
                <h6 class="card-title fs-lg lh-base mb-2">
                    <a href="{{ route('third', ['apps', 'others', 'article'])}}" class="link-reset">SEO Strategies for 2025: How to Rank Higher</a>
                </h6>
                <p class="mb-3 text-muted">
    ...
    <div class="col-xl-3 col-md-6">
        <article class="card">
            ...
            <div class="card-body">
                <!-- Title -->
                <h6 class="card-title fs-lg lh-base mb-2">
                    <a href="{{ route('third', ['apps', 'others', 'article'])}}" class="link-reset">5 Key Tips for New Entrepreneurs</a>
                </h6>
                <p class="mb-3 text-muted">
    ...
    <div class="col-xl-3 col-md-6">
        <article class="card">
            ...
            <div class="card-body">
                <!-- Title -->
                <h6 class="card-title fs-lg lh-base mb-2">
                    <a href="{{ route('third', ['apps', 'others', 'article'])}}" class="link-reset">The Future of Artificial Intelligence</a>
                </h6>
                <p class="mb-3 text-muted">
    ...
    <div class="col-xl-3 col-md-6">
        <article class="card bg-secondary bg-gradient">
            ...
            <div class="card-body">
                ...
                <!-- Title -->
                <h6 class="card-title fs-lg lh-base mb-2">
                    <a href="{{ route('third', ['apps', 'others', 'article'])}}" class="text-white">Cyber Threats to Watch Out for in 2025</a>
                </h6>
                <p class="mb-3 text-white-50">
    ...
    <div class="col-xl-3 col-md-6">
        <article class="card">
            ...
            <div class="card-body">
                <!-- Title -->
                <h6 class="card-title fs-lg lh-base mb-2">
                    <a href="{{ route('third', ['apps', 'others', 'article'])}}" class="link-reset">Top Data Science Trends in 2025</a>
                </h6>
                <p class="mb-3 text-muted">
    ...
    <div class="col-xl-3 col-md-6">
        <article class="card">
            ...
            <div class="card-body">
                ...
                <!-- Title -->
                <h6 class="card-title fs-lg lh-base mb-2">
                    <a href="{{ route('third', ['apps', 'others', 'article'])}}" class="link-reset">Web Design Trends to Watch in 2025</a>
                </h6>
                <p class="mb-3 text-muted">
    ...
    <div class="col-xl-3 col-md-6">
        <article class="card bg-success bg-gradient">
            ...
            <div class="card-body">
                ...
                <!-- Title -->
                <h6 class="card-title fs-lg lh-base mb-2">
                    <a href="{{ route('third', ['apps', 'others', 'article'])}}" class="text-white">Sustainable Technologies Shaping the Future</a>
                </h6>
                <p class="mb-3 text-white-50">
