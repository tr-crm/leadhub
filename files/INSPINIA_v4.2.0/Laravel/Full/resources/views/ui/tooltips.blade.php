                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">
                            Documentation and examples for adding custom Bootstrap tooltips with CSS and JavaScript using
                            CSS3 for animations and data-bs-attributes for local title storage.
                        </p>

                        <a class="btn btn-link p-0 fw-semibold"
                            href="https://getbootstrap.com/docs/5.3/components/tooltips/" target="_blank">
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-0">
                            Powerful admin features like <a href="#" class="fw-medium" data-bs-toggle="tooltip"
                                data-bs-title="Manage your dashboard easily">custom dashboards</a> and UI components help
                            you build scalable web applications efficiently.
                            This template includes pre-built pages, clean layouts, and reusable code blocks to boost your
                            development workflow.
                            From user management to analytics and settings, everything is modular and developer-friendly.
                            Create modern admin panels with <a href="#" class="fw-medium" data-bs-toggle="tooltip"
                                data-bs-title="Built with Bootstrap 5">responsive design</a> and seamless UX.
                            Get started quickly with a professional-grade <a href="#" class="fw-medium"
                                data-bs-toggle="tooltip" data-bs-title="Tailored for developers">UI toolkit</a> and
                            supercharge your app with <a href="#" class="fw-medium" data-bs-toggle="tooltip"
                                data-bs-title="Includes charts, tables, forms and more">powerful components</a> and flexible
                            layouts.
                        </p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-primary" type="button" data-bs-toggle="tooltip" data-bs-trigger="hover"
                            data-bs-title="Tooltip appears on hover only">Hover to See Info</button>
                    </div> <!-- end card-body -->
                </div> <!-- end card-->
            </div> <!-- end col -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <button type="button" class="btn btn-info" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-title="Tooltip on top">Tooltip ontop</button>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button type="button" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                data-bs-title="This is a warning tooltip to alert you.">
                                Warning tooltip
                            </button>
                            ...
                            <button type="button" class="btn btn-purple" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                data-bs-title="This is a purple tooltip with a vibrant style.">
                                Purple tooltip
                            </button>
                        </div>
                    </div> <!-- end card-body -->
