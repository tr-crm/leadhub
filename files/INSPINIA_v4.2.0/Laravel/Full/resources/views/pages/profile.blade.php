                ...
                <article class="card rounded-3">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="card-title fs-lg lh-base mb-2">
                            <a href="{{route('third', ['apps', 'other', 'article'])}}" class="link-reset">The Future of Artificial
                                Intelligence</a>
                        </h6>
                    ...
                    <div class="card-footer bg-transparent d-flex justify-content-between">
                        ...
                        <a class="link-primary fw-semibold" href="{{route('third', ['apps', 'other', 'article'])}}">Read more <i class="ti ti-arrow-right"></i></a>
                    </div>
                </article>
            </div> <!-- end col-->
            ...
            <div class="col-xl-4 col-md-6">
                <article class="card rounded-3">
                    ...
                    <div class="card-body">
                        <!-- Title -->
                        <h6 class="card-title fs-lg lh-base mb-2">
                            <a href="{{route('third', ['apps', 'other', 'article'])}}" class="link-reset">Top Data Science Trends in 2025</a>
                        </h6>
                        <p class="mb-3 text-muted">
            ...
            <div class="col-xl-4 col-md-6">
                <article class="card rounded-3">
                    ...
                    <div class="card-body">
                        <!-- Title -->
                        <h6 class="card-title fs-lg lh-base mb-2">
                            <a href="{{route('third', ['apps', 'other', 'article'])}}" class="link-reset">5 Key Tips for New Entrepreneurs</a>
                        </h6>
                        <p class="mb-3 text-muted">
