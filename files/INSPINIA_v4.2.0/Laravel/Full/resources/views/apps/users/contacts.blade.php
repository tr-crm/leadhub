        ...
        <div class="card card-h-100">
            <div class="card-body">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h5 class="mb-1 d-flex align-items-center">
                            <a href="{{ route('second', ['pages', 'profile'])}}" class="link-reset">Sophia Carter</a>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('second', ['pages', 'profile'])}}" class="btn btn-soft-primary btn-sm rounded-pill">View Profile</a>
                </div>
            </div>
        </div>
    </div> <!-- end col-->
        ...
        <div class="card card-h-100">
            <div class="card-body">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h5 class="mb-1 d-flex align-items-center">
                            <a href="{{ route('second', ['pages', 'profile'])}}" class="link-reset">Marcus Lee</a>
        ...
        <div class="card card-h-100">
            <div class="card-body">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h5 class="mb-1 "><a href="{{ route('second', ['pages', 'profile'])}}" class="link-reset">Emily Davis</a> <img src="/images/flags/us.svg" alt="US" class="ms-2 rounded-circle" height="16"></h5>
        ...
        <div class="card card-h-100">
            <div class="card-body">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h5 class="mb-1"><a href="{{ route('second', ['pages', 'profile'])}}" class="link-reset">Daniel Smith</a> <img src="/images/flags/ca.svg" alt="US" class="ms-2 rounded-circle" height="16"></h5>
        ...
        <div class="card card-h-100">
            <div class="card-body">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h5 class="mb-1 d-flex align-items-center">
                            <a href="{{ route('second', ['pages', 'profile'])}}" class="link-reset">Daniel Morris</a>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <span class="text-muted fs-xs"><i class="ti ti-refresh me-1"></i>Updated 1 hour ago</span>
                    <a href="{{ route('second', ['pages', 'profile'])}}" class="btn btn-soft-success btn-sm rounded-pill">View Profile</a>
                </div>
            </div>
        </div>
    </div> <!-- end col -->
        ...
        <div class="card card-h-100">
            <div class="card-body">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h5 class="mb-1"><a href="{{ route('second', ['pages', 'profile'])}}" class="link-reset">Jessica Chen</a> <img src="/images/flags/cn.svg" alt="CN" class="ms-2 rounded-circle" height="16"></h5>
        ...
        <div class="card card-h-100">
            <div class="card-body">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h5 class="mb-1"><a href="{{ route('second', ['pages', 'profile'])}}" class="link-reset">Arjun Patel</a> <img src="/images/flags/in.svg" alt="IN" class="ms-2 rounded-circle" height="16"></h5>
        ...
        <div class="card card-h-100">
            <div class="card-body">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h5 class="mb-1"><a href="{{ route('second', ['pages', 'profile'])}}" class="link-reset">Olivia Garcia</a> <img src="/images/flags/es.svg" alt="ES" class="ms-2 rounded-circle" height="16"></h5>
