...
@include('layouts.partials/page-title', ['subtitle' => 'Apps', 'title' => 'Projects'])
            ...
            <div class="row gap-3">
                ...
                <div class="col-auto">
                    <div class="d-flex gap-1">
                        <a href="{{route('third', ['apps', 'projects', 'index'])}}" class="btn btn-primary btn-icon">
                            <i data-lucide="layout-grid" class="fs-lg"></i>
                        </a>
                        <a href="{{route('third', ['apps', 'projects', 'list'])}}" class="btn btn-soft-primary btn-icon">
                ...
                <div class="d-flex mb-4">
                    ...
                    <div>
                        <h5 class="mb-1 d-flex align-items-center">
                            <a href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">AI Analytics Dashboard</a>
                        </h5>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex mb-4">
                    ...
                    <div>
                        <h5 class="mb-1 d-flex align-items-center">
                            <a href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">Marketing Automation Platform</a>
                        </h5>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex mb-4">
                    ...
                    <div>
                        <h5 class="mb-1 d-flex align-items-center">
                            <a href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">Website Redesign</a>
                        </h5>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex mb-4">
                    ...
                    <div>
                        <h5 class="mb-1 d-flex align-items-center">
                            <a href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">Sales Insight Tool</a>
                        </h5>
    ...
    <div class="col-md-6 col-xxl-3">
        <div class="card">
            <div class="card-header bg-light-subtle border-light p-3">
                ...
                <div>
                    <h5 class="mb-1 d-flex align-items-center">
                        <a href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">Cyber Security System</a>
                    </h5>
    ...
    <div class="col-md-6 col-xxl-3">
        <div class="card">
            <div class="card-header bg-light-subtle border-light p-3">
                ...
                <div>
                    <h5 class="mb-1 d-flex align-items-center">
                        <a href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">AI Performance Dashboard</a>
                    </h5>
    ...
    <div class="col-md-6 col-xxl-3">
        <div class="card">
            <div class="card-header bg-light-subtle border-light p-3">
                ...
                <div>
                    <h5 class="mb-1 d-flex align-items-center">
                        <a href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">Cloud Sync Platform</a>
                    </h5>
    ...
    <div class="col-md-6 col-xxl-3">
        <div class="card">
            <div class="card-header bg-light-subtle border-light p-3">
                ...
                <div>
                    <h5 class="mb-1 d-flex align-items-center">
                        <a href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">Data Mining Toolkit</a>
                    </h5>
