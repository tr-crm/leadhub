@extends('layouts.vertical', ['title' => 'Projects List'])

@section('content')

@include('layouts.partials/page-title', ['subtitle' => 'Apps', 'title' => 'Projects List'])
        ...
        <div data-table data-table-rows-per-page="8" class="card">
            <div class="card-header border-light justify-content-between">
                ...
                <div class="d-flex gap-1">
                    <a href="{{route('third', ['apps', 'projects', 'index'])}}" class="btn btn-soft-primary btn-icon">
                        <i data-lucide="layout-grid" class="fs-lg"></i>
                    </a>
                    <a href="{{route('third', ['apps', 'projects', 'list'])}}" class="btn btn-primary btn-icon">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a data-sort="project" href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">AI Analytics
                                                Dashboard</a>
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a data-sort="project" href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">E-commerce
                                                Platform</a>
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a data-sort="project" href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">UI Kit Design</a>
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a data-sort="project" href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">Website
                                                Redesign</a>
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a data-sort="project" href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">Marketing
                                                Report</a>
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a data-sort="project" href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">Sales Pitch
                                                Deck</a>
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a data-sort="project" href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">Mobile UI
                                                Mockups</a>
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a data-sort="project" href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">Server
                                                Maintenance</a>
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a data-sort="project" href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">Security Audit</a>
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a data-sort="project" href="{{route('third', ['apps', 'projects', 'details'])}}" class="link-reset">Plugin
                                                Development</a>
                                        </h5>
