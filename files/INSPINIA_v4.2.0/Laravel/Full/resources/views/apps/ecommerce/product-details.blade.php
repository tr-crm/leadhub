                        ...
                        <div class="card card-top-sticky border-0">
                            <div class="card-body p-0">
                                ...
                                <div id="carouselExampleFade" class="carousel slide carousel-fade"
                                    ...
                                    <div class="carousel-inner bg-light bg-opacity-25 border border-light border-dashed rounded-3"
                                        ...
                                        <div class="carousel-item text-center active">
                                            <img src="/images/products/single-1.png" alt="" class="img-fluid">
                                        </div>
                                        <div class="carousel-item text-center">
                                            <img src="/images/products/single-2.png" alt="" class="img-fluid">
                                        </div>
                                        <div class="carousel-item text-center">
                                            <img src="/images/products/single-3.png" alt="" class="img-fluid">
                                        </div>
                                        <div class="carousel-item text-center">
                                            <img src="/images/products/single-4.png" alt="" class="img-fluid">
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="0"
                                            ...
                                            <img src="/images/products/single-1.png" class="d-block avatar-xl"
                                                alt="indicator-img">
                                        </button>
                                        <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="1"
                                            aria-label="Slide 2" class="h-auto rounded bg-light-subtle border"
                                            style="width: auto !important;">
                                            <img src="/images/products/single-2.png" class="d-block avatar-xl"
                                                alt="indicator-img">
                                        </button>
                                        <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="2"
                                            aria-label="Slide 3" class="h-auto rounded bg-light-subtle border"
                                            style="width: auto !important;">
                                            <img src="/images/products/single-3.png" class="d-block avatar-xl"
                                                alt="indicator-img">
                                        </button>
                                        <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="3"
                                            aria-label="Slide 4" class="h-auto rounded bg-light-subtle border"
                                            style="width: auto !important;">
                                            <img src="/images/products/single-4.png" class="d-block avatar-xl"
                                                alt="indicator-img">
                                        </button>
                                    </div>
                                </div> <!-- end carousel-->
                                ...
                                <div class="text-center my-3">
                                    <a href="{{ route('third', ['apps', 'ecommerce', 'add-product'])}}" class="btn btn-light me-1"><i
                                            class="ti ti-pencil fs-lg me-1"></i> Edit</a>
                                    <a href="{{ route('third', ['apps', 'ecommerce', 'add-product'])}}" class="btn btn-danger"><i
                        ...
                        <div class="p-4">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="flex-grow-1 d-inline-flex align-items-center justify-content-end fs-lg">
                                    ...
                                    <span class="ti ti-star-filled text-warning"></span>
                                    <span class="ti ti-star-filled text-warning"></span>
                                    <span class="ms-1 fs-base"><a href="{{ route('third', ['apps', 'ecommerce', 'review'])}}"
