                ...
                <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <h5 class="fs-sm mb-0 fw-medium"><a href="{{ route('third', ['apps', 'ecommerce', 'order-details'])}}"
                                        class="link-reset">#WB20100</a></h5>
                            </td>
                            ...
                            <td>
                                <div class="d-flex justify-content-start align-items-center gap-2">
                                    ...
                                    <div>
                                        <h5 data-sort="customer" class="text-nowrap fs-base mb-0 lh-base">Mason Carter
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-start align-items-center gap-2">
                                    ...
                                    <div>
                                        <h5 data-sort="customer" class="text-nowrap fs-base mb-0 lh-base">Ava Martin
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-start align-items-center gap-2">
                                    ...
                                    <div>
                                        <h5 data-sort="customer" class="text-nowrap fs-base mb-0 lh-base">Noah Wilson
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <h5 class="fs-sm mb-0 fw-medium"><a href="{{ route('third', ['apps', 'ecommerce', 'order-details'])}}"
                                        class="link-reset">#WB20104</a></h5>
                            </td>
                            <td>28 Apr, 2025 <small class="text-muted">9:55 AM</small></td>
                            <td>
                                <div class="d-flex justify-content-start align-items-center gap-2">
                                    <div class="avatar avatar-sm">
                                        <img src="/images/users/user-5.jpg" alt="avatar-11"
                                            class="img-fluid rounded-circle">
                                    </div>
                                    <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-start align-items-center gap-2">
                                    ...
                                    <div>
                                        <h5 data-sort="customer" class="text-nowrap fs-base mb-0 lh-base">Emma Johnson
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-start align-items-center gap-2">
                                    ...
                                    <div>
                                        <h5 data-sort="customer" class="text-nowrap fs-base mb-0 lh-base">Sophia Davis
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-start align-items-center gap-2">
                                    ...
                                    <div>
                                        <h5 data-sort="customer" class="text-nowrap fs-base mb-0 lh-base">Oliver Brown
                                        </h5>
