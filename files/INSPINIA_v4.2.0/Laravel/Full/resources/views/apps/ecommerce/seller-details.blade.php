                ...
                <div data-table data-table-rows-per-page="8" class="card">
                    <div class="card-header border-light justify-content-between">
                        ...
                        <div class="d-flex gap-1">
                            ...
                            <a href="ecommerce-add-product.html" class="btn btn-danger ms-1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h5 class="mb-0">
                                                    <a data-sort="product" href="ecommerce-product-details.html" class="link-reset">Vintage
                                                        Leather Wallet</a>
                                                </h5>
                                            </div>
                                        </div>
...
@section('scripts')
@vite(['resources/js/pages/custom-table.js', 'resources/js/pages/ecommerce-seller-details.js'])
@endsection