                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="product" href="{{ route('third', ['apps', 'ecommerce', 'product-details'])}}"
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 data-sort="reviewer" class="text-nowrap fs-sm mb-0 lh-base">Sophia Lee
                                            </h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="product" href="{{ route('third', ['apps', 'ecommerce', 'product-details'])}}"
                                                    class="link-reset">Smart Watch</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 data-sort="reviewer" class="text-nowrap fs-sm mb-0 lh-base">David Smith
                                            </h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="product" href="{{ route('third', ['apps', 'ecommerce', 'product-details'])}}"
                                                    class="link-reset">4K Ultra HD TV</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 data-sort="reviewer" class="text-nowrap fs-sm mb-0 lh-base">Alice Johnson
                                            </h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="product" href="{{ route('third', ['apps', 'ecommerce', 'product-details'])}}"
                                                    class="link-reset">Smartphone X</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 data-sort="reviewer" class="text-nowrap fs-sm mb-0 lh-base">Michael Green
                                            </h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="product" href="{{ route('third', ['apps', 'ecommerce', 'product-details'])}}"
                                                    class="link-reset">Gaming Laptop</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 data-sort="reviewer" class="text-nowrap fs-sm mb-0 lh-base">Chris Evans
                                            </h5>
...
@section('scripts')
    @vite(['resources/js/pages/custom-table.js', 'resources/js/pages/ecommerce-reviews.js'])
@endsection
