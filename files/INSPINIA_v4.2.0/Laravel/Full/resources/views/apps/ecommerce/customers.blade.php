            ...
            <div data-table data-table-rows-per-page="8" class="card">
                <div class="card-header border-light d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <!-- Export Dropdown -->
                        <div class="dropdown">
                            <button class="btn btn-default dropdown-toggle drop-arrow-none" type="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <i data-lucide="download" class="me-1"></i> Export <i
                    ...
                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                            ...
                            <tr class="text-uppercase fs-xxs">
                                <th class="ps-3" style="width: 1%;">
                                    <input data-table-select-all class="form-check-input form-check-input-light fs-14 mt-0"
                                        type="checkbox" id="select-all-products">
                                </th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="{{ route('second', ['pages', 'profile'])}}" class="link-reset">Carlos
                                                    Méndez</a>
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <img src="/images/flags/us.svg" alt="" class="rounded-circle me-1"
                                        height="16"> United States
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="{{ route('second', ['pages', 'profile'])}}" class="link-reset">Sophie
                                                    Laurent</a>
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <img src="/images/flags/fr.svg" alt="" class="rounded-circle me-1"
                                        height="16"> France
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="{{ route('second', ['pages', 'profile'])}}"
                                                    class="link-reset">Akira Tanaka</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <img src="/images/flags/jp.svg" alt="" class="rounded-circle me-1"
                                        height="16"> Japan
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="{{ route('second', ['pages', 'profile'])}}" class="link-reset">Emma
                                                    Watson</a>
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="{{ route('second', ['pages', 'profile'])}}"
                                                    class="link-reset">Lucas Schmidt</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="{{ route('second', ['pages', 'profile'])}}"
                                                    class="link-reset">Isabella Rossi</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <img src="/images/flags/it.svg" alt="" class="rounded-circle me-1"
                                        height="16"> Italy
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="{{ route('second', ['pages', 'profile'])}}"
                                                    class="link-reset">Mateo Vargas</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <img src="/images/flags/ar.svg" alt="" class="rounded-circle me-1"
                                        height="16"> Argentina
                                </td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="{{ route('second', ['pages', 'profile'])}}"
                                                    class="link-reset">Priya Sharma</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="{{ route('second', ['pages', 'profile'])}}" class="link-reset">Liam
                                                    O’Connor</a>
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <img src="/images/flags/au.svg" alt="" class="rounded-circle me-1"
                                        height="16"> Australia
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="{{ route('second', ['pages', 'profile'])}}" class="link-reset">Olga
                                                    Petrova</a>
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <img src="/images/flags/ru.svg" alt="" class="rounded-circle me-1"
                                        height="16"> Russia
                                </td>
