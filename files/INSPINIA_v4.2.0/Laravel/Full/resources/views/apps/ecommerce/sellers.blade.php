                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="seller" href="{{ route('third', ['apps', 'ecommerce', 'seller-details'])}}" class="link-reset">GreenTech
                                                Solutions</a>
                                        </h5>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="{{ route('third', ['apps', 'ecommerce', 'review'])}}" class="link-reset fw-semibold">(4.5)</a></span>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="seller" href="{{ route('third', ['apps', 'ecommerce', 'seller-details'])}}" class="link-reset">TechTonic
                                                Store</a>
                                        </h5>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="{{ route('third', ['apps', 'ecommerce', 'review'])}}" class="link-reset fw-semibold">(3)</a></span>
                            </td>
                            <td>
                                <span class="badge p-1 text-bg-light fs-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="seller" href="{{ route('third', ['apps', 'ecommerce', 'seller-details'])}}" class="link-reset">UrbanTech
                                                Gadgets</a>
                                        </h5>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="{{ route('third', ['apps', 'ecommerce', 'review'])}}" class="link-reset fw-semibold">(3.5)</a></span>
                            </td>
                            <td>
                                <span class="badge p-1 text-bg-light fs-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="seller" href="{{ route('third', ['apps', 'ecommerce', 'seller-details'])}}" class="link-reset">NextGen
                                                Electronics</a>
                                        </h5>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="{{ route('third', ['apps', 'ecommerce', 'review'])}}" class="link-reset fw-semibold">(2)</a></span>
                            </td>
                            <td>
                                <span class="badge p-1 text-bg-light fs-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="seller" href="{{ route('third', ['apps', 'ecommerce', 'seller-details'])}}" class="link-reset">SmartHome
                                                Goods</a>
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="seller" href="{{ route('third', ['apps', 'ecommerce', 'seller-details'])}}" class="link-reset">TechMasters</a>
                                        </h5>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="{{ route('third', ['apps', 'ecommerce', 'review'])}}" class="link-reset fw-semibold">(5)</a></span>
                            </td>
                            <td>
                                <span class="badge p-1 text-bg-light fs-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="seller" href="{{ route('third', ['apps', 'ecommerce', 'seller-details'])}}" class="link-reset">FutureGizmos</a>
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="seller" href="{{ route('third', ['apps', 'ecommerce', 'seller-details'])}}" class="link-reset">GizmoX</a>
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="seller" href="{{ route('third', ['apps', 'ecommerce', 'seller-details'])}}" class="link-reset">NextWave
                                                Electronics</a>
                                        </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-1">
                                            <a data-sort="seller" href="{{ route('third', ['apps', 'ecommerce', 'seller-details'])}}" class="link-reset">FutureTech
                                                Innovations</a>
                                        </h5>
                            ...
                            <td>
                                ...
                                <span class="ms-1"><a data-sort="rating" href="{{ route('third', ['apps', 'ecommerce', 'review'])}}" class="link-reset fw-semibold">(4)</a></span>
                            </td>
                            <td>
                                <span class="badge p-1 text-bg-light fs-sm">
