            ...
            <div data-table data-table-rows-per-page="8" class="card">
                <div class="card-header border-light justify-content-between">
                    <div class="d-flex gap-2">
                        ...
                        <button type="submit" class="btn btn-purple rounded-circle btn-icon"><i
                                class="ti ti-plus fs-lg"></i></button>
                    </div>
                    ...
                    <table class="table table-custom table-centered table-hover w-100 mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm" id="keyOne"
                                            readonly value="e4A7Fc98z120XYz776abc90MNZ">
                                        <button class="btn btn-sm btn-icon btn-light" type="button"
                                            data-clipboard-target="#keyOne">
                                ...
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                                        <img src="/images/flags/de.svg" alt="" class="rounded-circle me-1"
                                            height="12"> DE
                                    </span>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm" id="keyTwo"
                                            readonly value="9BcD456Xy78LmN0zPQR12sA3Z">
                                        <button class="btn btn-sm btn-icon btn-light" type="button"
                                            data-clipboard-target="#keyTwo">
                                            <i class="ti ti-copy fs-lg"></i>
                                        </button>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                                        <img src="/images/flags/gb.svg" alt="" class="rounded-circle me-1"
                                            height="12"> UK
                                    </span>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm" id="keyThree"
                                            readonly value="ZZ99xC8K23Fm10TyPLqZa17d">
                                        <button class="btn btn-sm btn-icon btn-light" type="button"
                                            data-clipboard-target="#keyThree">
                                            <i class="ti ti-copy fs-lg"></i>
                                        </button>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                                        <img src="/images/flags/in.svg" alt="" class="rounded-circle me-1"
                                            height="12"> IN
                                    </span>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm" id="keyFour"
                                            readonly value="XY91kLpB42Ga98WxRTzEe55n">
                                        <button class="btn btn-sm btn-icon btn-light" type="button"
                                            data-clipboard-target="#keyFour">
                                            <i class="ti ti-copy fs-lg"></i>
                                        </button>
                                    </div>
                                </td>
                                ...
                                <td>Apr 10, 2025</td>
                                <td>Oct 10, 2025</td>
                                <td><span class="badge p-1 text-bg-light fs-sm"><img src="/images/flags/us.svg"
                                            alt="" class="rounded-circle me-1" height="12"> US</span></td>
                                <td>
                                    <div class="d-flex align-items-center justify-content-center gap-1">
                                        <a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i
                                                class="ti ti-eye fs-lg"></i></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        <div class="avatar avatar-xs">
                                            <img src="/images/users/user-7.jpg" alt="avatar-7"
                                                class="img-fluid rounded-circle">
                                        </div>
                                        <div>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm" id="keyFive"
                                            readonly value="BB22zWqT65Op90VxMLaRt18c">
                                        <button class="btn btn-sm btn-icon btn-light" type="button"
                                            data-clipboard-target="#keyFive">
                                            <i class="ti ti-copy fs-lg"></i>
                                        </button>
                                    </div>
                                </td>
                                ...
                                <td>Mar 15, 2025</td>
                                <td>Sep 15, 2025</td>
                                <td><span class="badge p-1 text-bg-light fs-sm"><img src="/images/flags/de.svg"
                                            alt="" class="rounded-circle me-1" height="12"> DE</span></td>
                                <td>
                                    <div class="d-flex align-items-center justify-content-center gap-1">
                                        <a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i
                                                class="ti ti-eye fs-lg"></i></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm" id="keySix"
                                            readonly value="RM19yUlP75Kl44YvNJdHg09s">
                                        <button class="btn btn-sm btn-icon btn-light" type="button"
                                            data-clipboard-target="#keySix">
                                            <i class="ti ti-copy fs-lg"></i>
                                        </button>
                                    </div>
                                </td>
                                ...
                                <td>Jan 01, 2025</td>
                                <td>Dec 31, 2025</td>
                                <td><span class="badge p-1 text-bg-light fs-sm"><img src="/images/flags/gb.svg"
                                            alt="" class="rounded-circle me-1" height="12"> UK</span></td>
                                <td>
                                    <div class="d-flex align-items-center justify-content-center gap-1">
                                        <a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i
                                                class="ti ti-eye fs-lg"></i></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm" id="keySeven"
                                            readonly value="AA47qBcJ61Tr77WpKKzTy39k">
                                        <button class="btn btn-sm btn-icon btn-light" type="button"
                                            data-clipboard-target="#keySeven">
                                            <i class="ti ti-copy fs-lg"></i>
                                        </button>
                                    </div>
                                </td>
                                ...
                                <td>Feb 01, 2025</td>
                                <td>May 01, 2025</td>
                                <td><span class="badge p-1 text-bg-light fs-sm"><img src="/images/flags/au.svg"
                                            alt="" class="rounded-circle me-1" height="12"> AU</span></td>
                                <td>
                                    <div class="d-flex align-items-center justify-content-center gap-1">
                                        <a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i
                                                class="ti ti-eye fs-lg"></i></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm" id="keyEight"
                                            readonly value="ZP83mXcD28Uv11MtYYoXx03b">
                                        <button class="btn btn-sm btn-icon btn-light" type="button"
                                            data-clipboard-target="#keyEight">
                                            <i class="ti ti-copy fs-lg"></i>
                                        </button>
                                    </div>
                                </td>
                                ...
                                <td>Apr 01, 2025</td>
                                <td>Jan 01, 2026</td>
                                <td><span class="badge p-1 text-bg-light fs-sm"><img src="/images/flags/ca.svg"
                                            alt="" class="rounded-circle me-1" height="12"> CA</span></td>
                                <td>
                                    <div class="d-flex align-items-center justify-content-center gap-1">
                                        <a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i
                                                class="ti ti-eye fs-lg"></i></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm" id="keyNine"
                                            readonly value="LK35yTrF82Lo99UiSSpPr47x">
                                        <button class="btn btn-sm btn-icon btn-light" type="button"
                                            data-clipboard-target="#keyNine">
                                            <i class="ti ti-copy fs-lg"></i>
                                        </button>
                                    </div>
                                </td>
                                ...
                                <td>Jul 15, 2024</td>
                                <td>Jan 15, 2025</td>
                                <td><span class="badge p-1 text-bg-light fs-sm"><img src="/images/flags/fr.svg"
                                            alt="" class="rounded-circle me-1" height="12"> FR</span></td>
                                <td>
                                    <div class="d-flex align-items-center justify-content-center gap-1">
                                        <a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i
                                                class="ti ti-eye fs-lg"></i></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm" id="keyTen"
                                            readonly value="DW64aUvQ11Gh32PpDDjWw72t">
                                        <button class="btn btn-sm btn-icon btn-light" type="button"
                                            data-clipboard-target="#keyTen">
                                            <i class="ti ti-copy fs-lg"></i>
                                        </button>
                                    </div>
                                </td>
                                ...
                                <td>Mar 05, 2025</td>
                                <td>Dec 05, 2025</td>
                                <td><span class="badge p-1 text-bg-light fs-sm"><img src="/images/flags/in.svg"
                                            alt="" class="rounded-circle me-1" height="12"> IN</span></td>
                                <td>
                                    <div class="d-flex align-items-center justify-content-center gap-1">
                                        <a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i
                                                class="ti ti-eye fs-lg"></i></a>
...
@section('scripts')
    @vite(['resources/js/pages/custom-table.js', 'resources/js/pages/api-keys.js'])
@endsection
