@extends('layouts.vertical', ['title' => 'Inbox (77)'])
...
<div class="outlook-box email-app">
    <div class="offcanvas-lg offcanvas-start outlook-left-menu outlook-left-menu-sm" tabindex="-1"
        ...
        <div class="card h-100 mb-0 rounded-end-0" data-simplebar>
            <div class="card-body">
                <a href="{{ route('third', ['apps', 'email' ,'compose'])}}" class="btn btn-danger fw-medium w-100">Compose</a>

                <div class="list-group list-group-flush list-custom mt-3">
                    <a href="{{ route('third', ['apps', 'email' ,'inbox'])}}" class="list-group-item list-group-item-action active">
                ...
                <table class="table table-hover table-select mb-0">
                    <tbody>
                        <tr class="position-relative">
                            ...
                            <td>
                                <a href="{{ route('third', ['apps', 'email' ,'details'])}}" class="link-reset fs-base fw-medium stretched-link">
