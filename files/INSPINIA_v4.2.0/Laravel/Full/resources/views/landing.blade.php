        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div>
                    ...
                    <a href="{{ route('second', ['auth1', 'login'])}}" class="btn btn-sm btn-primary">Register</a>
                </div>
    ...
    <div class="container">
        <div class="row align-items-center pb-5">
            ...
            <div class="col-lg-5 ms-auto py-3">
                ...
                <a href="{{ route('second', ['apps', 'chat'])}}" class="btn btn-primary mb-4">Check Chat App</a>
        ...
        <div class="row align-items-center py-5">
            <div class="col-lg-5 py-5 order-2 order-lg-1">
                ...
                <a href="{{ route('second', ['apps', 'file-manager'])}}" class="btn btn-primary mb-4">Explore File Manager</a>
        ...
        <div class="row align-items-center py-5">
            ...
            <div class="col-lg-5 ms-auto py-3">
                ...
                <a href="{{ route('third', ['apps', 'users','contacts'])}}" class="btn btn-primary mb-4">Check Contacts App</a>
