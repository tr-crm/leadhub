...
<head>
    <?= $this->element('title_meta', ['title' => 'Outlook View']) ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?= $this->element('page_title', ['subtitle' => 'Apps', 'title' => 'Outlook View']) ?>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade show active" id="outlook-tab-2" role="tabpanel">
                                    ...
                                    <p>
                                        Once these changes are in place, we can finalize the QA pass and move on to staging. Let me know if you need any additional or approvals on my end.
                                    </p>
