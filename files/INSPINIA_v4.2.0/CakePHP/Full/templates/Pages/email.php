...
<head>
    <?= $this->element('title_meta', ['title' => 'Inbox (77)']) ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?= $this->element('page_title', ['subtitle' => 'Apps', 'title' => 'Email']) ?>
                                ...
                                <table class="table table-hover table-select mb-0">
                                    <tbody>
                                        <tr class="position-relative">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="/images/users/user-5.jpg" alt="user avatar" class="avatar-xs rounded-circle">
                                        ...
                                        <tr class="position-relative">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="/images/users/user-2.jpg" alt="user avatar" class="avatar-xs rounded-circle">
                                        ...
                                        <tr class="position-relative mark-as-read">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="/images/users/user-6.jpg" alt="user avatar" class="avatar-xs rounded-circle">
                                        ...
                                        <tr class="position-relative mark-as-read">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="/images/users/user-7.jpg" alt="user avatar" class="avatar-xs rounded-circle">
                                        ...
                                        <tr class="position-relative">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="/images/users/user-8.jpg" alt="user avatar" class="avatar-xs rounded-circle">
                                        ...
                                        <tr class="position-relative mark-as-read">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="/images/users/user-10.jpg" alt="user avatar" class="avatar-xs rounded-circle">
                                        ...
                                        <tr class="position-relative mark-as-read">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="/images/users/user-3.jpg" alt="user avatar" class="avatar-xs rounded-circle">
                                        ...
                                        <tr class="position-relative mark-as-read">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="/images/users/user-9.jpg" alt="user avatar" class="avatar-xs rounded-circle">
                                        ...
                                        <tr class="position-relative mark-as-read">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="/images/users/user-1.jpg" alt="user avatar" class="avatar-xs rounded-circle">
