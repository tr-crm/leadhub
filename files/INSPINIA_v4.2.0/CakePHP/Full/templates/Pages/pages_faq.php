...
<head>
    <?= $this->element('title_meta', ['title' => 'v']) ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?= $this->element('page_title', ['subtitle' => 'Pages', 'title' => 'FAQs']) ?>
                                        ...
                                        <div class="accordion accordion-bordered" id="BorderedaccordionRefund">
                                            ...
                                            <div class="accordion-item border-0">
                                                ...
                                                <div id="refundCollapseThree" class="accordion-collapse collapse" aria-labelledby="refundHeadingThree" data-bs-parent="#BorderedaccordionRefund">
                                                    <div class="accordion-body">
                                                        Custom services, extended licenses, and downloadable with confirmed usage typically aren’t refundable.
                                                    </div>
                                                </div>
                                            </div>
