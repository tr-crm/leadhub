    ...
    <Container fluid>
      ...
      <Card className="p-4 shadow-sm mx-auto" style={{ maxWidth: 700 }}>
        <Form onSubmit={handleSubmit}>
          ...
          <Row className="mb-3 align-items-center">
            <Col sm={3}><Form.Label>Name</Form.Label></Col>
            <Col sm={5}>
              <Form.Control
                type="text"
          ...
          <Row className="mb-3 align-items-center">
            <Col sm={3}><Form.Label>Phone</Form.Label></Col>
            <Col sm={5}>
              <Form.Control
                type="text"
          ...
          <Row className="mb-3 align-items-center">
            <Col sm={3}><Form.Label>Source</Form.Label></Col>
            <Col sm={5}>
              <Select
          ...
          <Row className="mb-3 align-items-center">
            <Col sm={3}><Form.Label>Category</Form.Label></Col>
            <Col sm={5}>
              <Select
          ...
          {shouldShowSubCategory && (
            <Row className="mb-3 align-items-center">
              <Col sm={3}><Form.Label>Subcategory</Form.Label></Col>
              <Col sm={5}>
                <Select
          ...
          {shouldShowProduct && (
            <Row className="mb-3 align-items-center">
              <Col sm={3}><Form.Label>Product</Form.Label></Col>
              <Col sm={5}>
                <Select
